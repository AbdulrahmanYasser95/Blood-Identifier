...
app = App(title="Blood Identifier", width=1350, height=5000, layout="grid")

welcome_message = Text(app, text="\nWelcome to the blood identifier app\n", size=30, font="Calibri", color="red",grid=[3,0])
welcome_message = Text(app, text="Press ANALYSE RESULTS to import test results and analyse them", size=15, font="Calibri", color="grey",grid=[3,1])
welcome_message = Text(app, text="Press SAVE to save identified test results", size=15, font="Calibri", color="grey",grid=[3,3])
Spacer= Text(app, text="             ", size=50, grid=[0,4])
Result= Text(app, text=" ", size=200, font="Calibri", color='#F7515E', grid=[3,6])
